...
<body class="bg-light">
    ...
    <div class="container mt-5">
        ...
        <div class="table-responsive mb-5 card">
            ...
            $data = mysqli_query($db, "SELECT id, CAST(AES_DECRYPT(nama, UNHEX(SHA2('$key', 256))) AS CHAR) AS nama, NIM, jenis_kelamin, 
            jurusan, agama, IPK  FROM mahasiswa ");
            $jumlah_data = mysqli_num_rows($data);
            $total_halaman = ceil($jumlah_data / $batas);

            $data_mhs = mysqli_query($db, "SELECT id, CAST(AES_DECRYPT(nama, UNHEX(SHA2('$key', 256))) AS CHAR) AS nama, NIM, jenis_kelamin,
            jurusan, agama, IPK  FROM mahasiswa  LIMIT $halaman_awal, $batas");
            $no = $halaman_awal + 1;
            ...
            while ($mahasiswa = mysqli_fetch_array($data_mhs)) {
                ...
                echo "<td>" . htmlspecialchars($mahasiswa['nama'], ENT_QUOTES, 'UTF-8') . "</td>";
